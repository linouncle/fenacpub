...
"</td>");
		...
		* @Return : Void
		*/
		function writeCol_cabecas($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td colspan='14' class='cabecalho' bgcolor='#283796' ><span style='color:#fff; text-align:center' >".trim($value)."</span></td>");
		}
		...
		* @Return : Void
		*/
		function writeCol_cabecasImovel($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td colspan='17' class='cabecalho' bgcolor='#283796' ><span style='color:#fff; text-align:center' >".trim($value)."</span></td>");
		}
		...
		* @Return : Void
		*/
		function writeCol_cabecas_maior($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td colspan='13' class='cabecalho' bgcolor='#283796' ><span style='color:#fff; text-align:center' >".trim($value)."</span></td>");
		}
	...
	/*
		...
		* @Return : Void
		*/
		function writeCol_unidos($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td colspan='14' >".trim($value)."</td>");
		}
	...
	/*
		...
		* @Return : Void
		*/
		function writeCol_unidos_maior($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td colspan='13' >".trim($value)."</td>");
		}
