...
$pieces = explode(",", $imovel->iptu);
$iptu = str_replace("." , "" , $pieces[0] ); // Primeiro tira os pontos

$id_imovel = $imovel->id_imovel;

	$sql_alterar = mysql_query("UPDATE tabela_imovel SET  iptu='$iptu' WHERE id_imovel ='$id_imovel' "); 	
